...
S2 = read.csv("estimates of confounders plus original four metabolites in S2_model 4.csv.csv", row.names = 1)
S4 = read.csv("estimates of confounders plus original four metabolites in S4_model 4.csv", row.names = 1)
