...
pdf("Prediction_ULSAM.pdf")
plot(fits[[1]], col = "blue")
plot(fits[[2]], col = "red", add = T)
...
legend("bottomright", legend = c("Framingham", "Framingham+hsCRP", "Framingham+LPC 18:2"), lty = c(2, 1,1,1), col = c("grey", "blue", "red"))
dev.off()
