...
tmp=residue(data=S4, Metabolites=metabo.asso.hyper.strin, adj=clinical.s4, control_group=which(S4$lthyact==2))
tmp2=residue(data=F4, Metabolites=metabo.asso.hyper.strin, adj=clinical.f4, control_group=which(F4$uthyact==2))
